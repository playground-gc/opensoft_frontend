...
const BalanceChart = ({ points }) => {
  ...
  const toY = (value) =>
    height - pad - ((value - minY) / ySpan) * (height - pad * 2);
...
export default function ProfilePage() {
  ...
  const points = useMemo(
    () => normalizeBalancePoints(balanceHistory),
    [balanceHistory],
  );
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "18px" }}>
        ...
        {loading && (
          <div style={{ marginBottom: "12px" }}>Loading profile data...</div>
        )}
        {!loading && error && (
